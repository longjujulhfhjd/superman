            ...
            var html =`
				...
				<div class="sup-module-right fl sup-procenter-banner-content">
					...
					<div class="padding-15-tb sup-module-right-time">
						<span class="sup-module-right-time-text"><i class="iconfont icon-clock sign"></i>${lists[id].time}</span>
						<span class="sup-module-right-time-text"><i class="iconfont icon-user-04 sign"></i>${lists[id].eye}</span>
					</div>
